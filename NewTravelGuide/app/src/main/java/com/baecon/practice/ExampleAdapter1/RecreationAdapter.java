...
public class RecreationAdapter extends RecyclerView.Adapter<RecreationAdapter.ExampleViewHolder> {
    private List<Recreation> exampleList;
    private List<Recreation> exampleListFull;
    ...
    public RecreationAdapter(List<Recreation> exampleList2, Context context) {
    ...
    public void onBindViewHolder(ExampleViewHolder holder, int position) {
        ...
        final Recreation currentItem = (Recreation) this.exampleList.get(position);
...
//        });
    ...
    public void setFilter(List<Recreation> filterdNames) {
